...
public class App {
  public static void main(String[] args) throws Exception {
    ...
    HttpHandler oiHandler = new OiHttpHandler();
    // Programar por Intenção
    HttpHandler testeHandler = new TesteHttpHandler();

    HttpHandler tchauHandler = new TchauHttpHandler();

    server.createContext("/oi", oiHandler);

    server.createContext("/teste", testeHandler);

    server.createContext("/tchau", tchauHandler);
...
class OiHttpHandler implements HttpHandler {
  ...
  public void handle(HttpExchange x) throws IOException {
    ...
    String resposta = "<html><head><title>Oi</title></head><body>Oi, <strong>tudo bem?</strong></body></html>";
...
class TesteHttpHandler implements HttpHandler {
  ...
  @Override
  public void handle(HttpExchange x) throws IOException {
    // O que chega na requisição: Método/Verbo, ex: GET, POST, DELETE, PUT, PATCH, OPTION,...
...
class TchauHttpHandler implements HttpHandler {
  ...
  public void handle(HttpExchange x) throws IOException {
    ...
    String resposta = "<html><head><title>Tchau</title></head><body>Tchau, <strong>" + nome + "!</strong></body></html>";
